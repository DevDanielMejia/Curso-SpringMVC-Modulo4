package com.daniel.curso.springboot.di.factura.springboot_difactura.models;
...
public class Invoice {
    ...
    public Invoice(){
        System.out.println("Creando el componende de la factura 1");
        
    }

    @PostConstruct
    public void init(){  
        System.out.println("Creando el componende de la factura 2");  
